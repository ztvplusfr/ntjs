...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log('🚀 Mise à jour du sitemap.xml via API...')
    ...
    // Note: Sur Vercel, vous ne pouvez pas écrire directement dans le système de fichiers
    // Cette API retourne le XML généré à la place
