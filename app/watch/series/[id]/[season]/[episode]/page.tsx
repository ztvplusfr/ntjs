...
export default function WatchSeriesPage() {
  ...
  useEffect(() => {
    if (serie && episodeDetails) {
      document.title = `Regarder ${serie.name} S${season}E${episode} - ${episodeDetails.name} en streaming HD gratuit`
      
      // Update meta description
      const metaDescription = document.querySelector('meta[name="description"]')
      if (metaDescription) {
        metaDescription.setAttribute('content', episodeDetails.overview || `Regarder ${serie.name} Saison ${season} Épisode ${episode} en streaming HD gratuit sur ZTVPlus`)
      }
      
      // Update Open Graph meta tags
      const ogTitle = document.querySelector('meta[property="og:title"]')
      if (ogTitle) {
        ogTitle.setAttribute('content', `Regarder ${serie.name} S${season}E${episode} en streaming`)
      }
      
      const ogDescription = document.querySelector('meta[property="og:description"]')
      if (ogDescription) {
        ogDescription.setAttribute('content', episodeDetails.overview || `Regarder ${serie.name} Saison ${season} Épisode ${episode} en streaming HD gratuit sur ZTVPlus`)
      }
      
      const ogImage = document.querySelector('meta[property="og:image"]')
      if (ogImage && episodeDetails.still_path) {
        ogImage.setAttribute('content', `https://image.tmdb.org/t/p/original${episodeDetails.still_path}`)
      }
      
      // Update Twitter meta tags
      const twitterTitle = document.querySelector('meta[name="twitter:title"]')
      if (twitterTitle) {
        twitterTitle.setAttribute('content', `Regarder ${serie.name} S${season}E${episode} en streaming`)
      }
      
      const twitterDescription = document.querySelector('meta[name="twitter:description"]')
      if (twitterDescription) {
        twitterDescription.setAttribute('content', episodeDetails.overview || `Regarder ${serie.name} Saison ${season} Épisode ${episode} en streaming HD gratuit sur ZTVPlus`)
      }
      
      const twitterImage = document.querySelector('meta[name="twitter:image"]')
      if (twitterImage && episodeDetails.still_path) {
        twitterImage.setAttribute('content', `https://image.tmdb.org/t/p/original${episodeDetails.still_path}`)
      }
    }
  }, [serie, episodeDetails, season, episode])
